  ...
  return (
    <div className="p-10">
      ...
      <div class="grid grid-cols-3 gap-10">
        {movie.length > 0 &&
          movie.map((item, index) => <MovieItem key={item.id} item={item}></MovieItem>)}
      </div>
    </div>
  );
};
    ...
    <div className="bg-white p-3 rounded-2xl shadow-sm">
      ...
      <div class="p-7">
        ...
        <p className="text-[#999] text-sm mb-6">
          ...
          blanditiis non libero. Reprehenderit dignissimos, ut eius quae
          architecto sequi aut hic est voluptates maiores quaerat illum officia
          fuga suscipit minus!
        </p>
