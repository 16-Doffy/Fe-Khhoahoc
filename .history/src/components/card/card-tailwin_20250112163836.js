...
const CardTailWind = (props) => {
  const amountClasses =`text-lg font-bold text-transparent bg-clip-text bg-radiant 
   ${props.primary ? "bg-radiant" : "bg-secondary-radiant"}`;
    ...
    <div className="relative w-[400px] mx-auto mt-12">
      ...
      <div className="absolute left-2/4 transform -translate-x-2/4 translate-y-2/4 bottom-0 bg-white z-10 rounded-[20px] p-5 w-[calc(100%-36px)]">
        ...
        <div className="flex items-center justify-between">
          <div className={`text-lg font-medium {props.frontSize || 'text-lg}`}>Comics Person</div>
