    ...
    return (
        <div className='bg-white p-3 rounded-2xl shadow-sm'>
            ...
            <div class="p-7">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia blanditiis non libero. Reprehenderit dignissimos, ut eius quae architecto sequi aut hic est voluptates maiores quaerat illum officia fuga suscipit minus!</p>
            </div>
        </div>
    )
}
