...
const SignUpForm = () => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      firstName: Yup.string().max(20, "character or less").required("Required"),
      lastName: Yup.string().max(10, "character or less").required("Requdsadadasired"),
    }),
    onSubmit: (values) => {
      console.log(values);
    },
    ...
    >
      <div className="flex flex-col gap-2 mb-5">
        ...
        <input
          ...
          {...formik.getFieldProps('fristName')} //auto add truong name
        />
